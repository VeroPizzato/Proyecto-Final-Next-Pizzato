        ...
        <main className="container m-auto w-1/3">
            ...
            <form onSubmit={handleSubmit} className="bg-gray-100 px-8 pt-6 pb-8 mb-4 rounded-xl shadow-lg">                
                ...
                <div className="mb-4">
                    ...
                    <input className="w-full shadow border border-blue-100 rounded py-2 px-3 text-gray-700 file:font-mono file:mr-6" type="file" placeholder="Ingrese imagen del producto" setFile={values.image} name="image" onChange={(e) => setFile(e.target.files[0])} required/>                   
                </div>
                <div className="mb-4">
