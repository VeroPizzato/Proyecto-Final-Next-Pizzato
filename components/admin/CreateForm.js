        ...
        <main className="container m-auto w-1/3">
            ...
            <form onSubmit={handleSubmit} className="bg-gray-100 px-8 pt-6 pb-8 mb-4 rounded-xl shadow-lg">
                ...
                <div className="mb-4">
                    ...
                    <input className="w-full shadow border border-blue-100 rounded py-2 px-3 text-gray-700 font-mono" type="text" placeholder="Ingrese nombre del producto" value={values.title} name="title" pattern="[A-Za-z]+" title="Solo se permiten letras" onChange={handleChange} required />
                </div>
                <div className="mb-4">
                ...
                <div className="flex items-center justify-center font-mono text-lg">
                    {
                        volver
                            ...
                            <div className="flex flex-col items-center justify-center font-mono text-lg">
                                <h2 className="text-2xl border-b border-gray-200 pb-4 mb-4 pt-6 font-bold text-center">Producto agregado con exito!!</h2>
