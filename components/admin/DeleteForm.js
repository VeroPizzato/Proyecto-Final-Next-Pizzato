    ...
    return (
        <main className="container m-auto w-1/2">
            <div className="bg-gray-100 px-8 pt-6 pb-8 mb-4 rounded-xl shadow-lg mt-6">
                <h1 className="text-4xl text-red-900 my-4 text-center font-mono">Esta seguro de eliminar el producto: {title} ? </h1>
                <hr />
                <div className="flex flex-row items-center justify-center">
                    {
                        volver
                            ...
                            <div className="flex flex-col items-center justify-center font-mono text-lg">
                                <h2 className="text-2xl border-b border-gray-200 pb-4 mb-4 pt-6 font-bold text-center">Producto eliminado con exito!!</h2>
