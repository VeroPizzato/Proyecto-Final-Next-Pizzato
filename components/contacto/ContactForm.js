        ...
        <main className="container m-auto max-w-md">
            ...
            <form className="bg-gray-100 px-8 pt-6 pb-8 mb-4 rounded-xl shadow-lg">
                <div className="mb-4">
                    ...
                    <textarea className="w-full shadow border border-red-900 rounded py-2 px-3 text-gray-700 font-mono" rows="5" type="text" placeholder="Dejanos un mensaje" required></textarea>
                </div>
                <div className="mb-4">
                    <label className="block text-gray-700 text-lg font-bold mb-2 font-mono" for="email"> Email </label>
                    <input className="w-full shadow border border-red-900 rounded py-2 px-3 text-gray-700 font-mono" type="email" placeholder="Tu email" required />
                </div>
